...
class AlbumDataSource {
    companion object {
        ...
        private fun getSong(artist_name: String, jsonSong: JSONObject, forUsersProfile: Boolean): Song {
            ...
            return Song(songName, artist_name, albumId, id, storageName, albumCover, forUsersProfile, songSuscription)
        }
        ...
        private fun getAlbum(artist_name: String, jsonAlbum: JSONObject, forUsersProfile: Boolean): Album {
            ...
            return Album(albumId, albumName, storageName, artist_name,
                ...
                description, genre, suscription, authorId, forUsersProfile)
        }
